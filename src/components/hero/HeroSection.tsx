...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col justify-center items-center pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center"
    >
      <motion.p
      ...
      <motion.p
        className="mt-4 text-lg text-[var(--text-muted)] max-w-xl mx-auto"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      <motion.p
        className="mt-2 text-[var(--text-muted)] max-w-xl mx-auto"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.div
        className="flex items-center justify-center gap-2 mt-3 text-sm text-[var(--text-muted)]"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
